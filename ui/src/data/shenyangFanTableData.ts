...
export const shenyangFanTableData: ShenyangFanItem[] = [
  // 0番 (规则说明)
  {
    ...
    name: '沈阳麻将规则概览',
    description:
      '沈阳麻将是辽宁省沈阳地区的特色麻将玩法，采用136张牌包含万、筒、索、风、字五类牌型，参与者共4人。该玩法以庄家轮换制为基础，开局时庄家持14张牌、其余玩家持13张牌，按逆时针顺序轮流出牌。和牌需满足开门、有横牌或中发白掌牌、包含幺九牌及三门齐等条件。胜负结算时自摸则三家负，点炮仅由放铳者担责（注：闭门不点炮亦需赔付），番数按2的幂次计算。允许旋风杠特殊算番机制。该玩法因规则复杂且娱乐性强，深受当地牌友欢迎。',
    example: '',
    tags: ['官方规则', '玩法简介'],
  },
  ...
  // 1番
  {
    ...
    name: '闭门 (负方惩罚)',
    description:
      '特定惩罚性质：对于所有处于‘闭门’状态的负方（即无吃、碰、明杠），不仅其必须向赢家支付分数（即便其不是点炮者），且其承担的结算番数 N 额外增加 1 番。',
    example: '',
    tags: ['负方惩罚', '强制支付', '1番叠加'],
  },
  {
  ...
  },
  {
    ...
    name: '手把一',
    description:
      '只在‘飘胡’（对对胡）的情况下成立。经过吃、碰、明杠后，手牌仅剩一张，单钓这张牌胡牌。计1番。沈阳规则下，非飘胡牌型不允许计手把一。',
  ...
  },
  {
    ...
    name: '旋风杠 (中发白)',
    description:
      '手中集齐中、发、白各一张即可亮雷。玩家可在自己行牌的任意回合亮出。计1番。\n注意：\n1. 亮出旋风杠不算开门（不影响闭门状态）。\n2. 在胡牌之前必须主动亮出，否则该局不得胡牌。',
  ...
  // 2番
  {
    ...
    name: '旋风杠 (东南西北)',
    description:
      '手中集齐东、南、西、北各一张即可亮雷。玩家可在自己行牌的任意回合亮出。计2番。\n注意：\n1. 亮出旋风杠不算开门（不影响闭门状态）。\n2. 在胡牌之前必须主动亮出，否则该局不得胡牌。',
