...
export const fanTableData: FanItem[] = [
  ...
  },
  {
    fan: 88,
    name: '大三元',
    description: '和牌中，有中发白3副刻子。不计箭刻、双箭刻。',
    example: '*Chun Chun Chun | *Hatsu Hatsu Hatsu | *Haku Haku Haku | Man1 Man2 Man3 | Pin1 Pin1',
  },
  {
    fan: 88,
    name: '绿一色',
    description: '由23468条及发字中的任何牌组成的顺子、刻子、将的和牌。不计混一色。如无发字组成的各牌，可计清一色。',
  ...
  },
  {
    fan: 64,
    name: '清幺九',
    description: '由序数牌一、九刻子组成的和牌。不计碰碰和、全带幺、幺九刻、无字。',
  ...
  },
  {
    fan: 64,
    name: '小三元',
    description: '和牌时有箭牌的2副刻子及将牌。不计双箭刻、箭刻。',
  ...
  },
  {
    fan: 64,
    name: '一色双龙会',
    description: '一种花色的两个老少副，5为将牌。不计平和、七对、清一色。',
  ...
  },
  {
    fan: 48,
    name: '一色四节高',
    description: '一种花色4副依次递增一位数的刻子。不计一色三同顺、碰碰和。',
    example: '*Man1 Man1 Man1 | *Man2 Man2 Man2 | *Man3 Man3 Man3 | *Man4 Man4 Man4 | Pin1 Pin1',
  },
  {
    fan: 32,
    name: '一色四步高',
    description: '一种花色4副依次递增一位数或二位数的顺子。',
  ...
  },
  {
    fan: 24,
    name: '清一色',
    description: '由一种花色的序数牌组成和牌。不计无字。',
  ...
  },
  {
    fan: 24,
    name: '全小',
    description: '由序数牌123组成的顺子、刻子(杠)、将牌的和牌。不计无字。',
  ...
  },
  {
    fan: 16,
    name: '一色三步高',
    description: '和牌时，有一种花色3副依次递增一位或二位数字的顺子。',
  ...
  },
  {
    fan: 1,
    name: '幺九刻',
    description: '3张相同的一、九序数牌或字牌组成的刻子(或杠)。',
  ...
  },
  {
    fan: 1,
    name: '边张',
    description: '单和123的3及789的7或1233和3、7789和7都为边张。手中有12345和3，56789和7不算边张。',
    example: '^Man1 ^Man2 Man3 | Pin4 Pin5 Pin6 | Sou7 Sou8 Sou9 | Ton Ton Ton | Nan Nan',
  },
  {
    fan: 1,
    name: '坎张',
    description: '和2条、4条之间的3条。4556和5也算坎张，手中有45567和6不算坎张。',
  ...
  { fan: 1, name: '自摸', description: '自己抓进牌成和牌。', example: '' },
  {
    fan: 1,
    name: '花牌',
    description: '即春夏秋冬，梅兰竹菊，每花计一分。不计在起和分内，和牌后才能计分。花牌补花成和计自摸，不计杠上开花。',
    example: '',
    tags: ['不计起和分'],
  },
]
