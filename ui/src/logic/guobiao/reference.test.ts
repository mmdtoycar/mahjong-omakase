  ...
  if (!pass) {
    ...
    expect(
      ...
      `Hand: ${handStr}\nNo combination matched expectations.\nFirst Actual: [${firstActual.join(
        ', '
      )}]\nExpected: [${mapped1.join(', ')}]${
        altFans ? ' OR [' + altFans.map((f) => FAN_NAME_MAP[f] || f).join(', ') + ']' : ''
      }`
    ).toBeTruthy()
  }
}
...
describe('GB-Mahjong Reference Tests', () => {
  ...
  describe('Fan Checks', () => {
    test('Case 205', () =>
      runTest('[EEE,2][SSSS,1]WWWNN55pN|EE1000', [
        'FAN_DASIXI',
        'FAN_HUNYISE',
        'FAN_SHUANGANKE',
        'FAN_MINGGANG',
    ...
    test('Case 206', () =>
      runTest('[EEE,2][SSSS,1]WWWNN555p|SN1000', [
        'FAN_XIAOSIXI',
        'FAN_HUNYISE',
        'FAN_PENGPENGHU',
        'FAN_QUANFENGKE',
    ...
    test('Case 208', () =>
      runTest('[EEE,2][SSS,1]WWW99m55p9m|NN1000', [
        'FAN_SANFENGKE',
        'FAN_PENGPENGHU',
        'FAN_SHUANGANKE',
        'FAN_YAOJIUKE',
    ...
    test('Case 209', () =>
      runTest('[PPP,2][FFF,3]CC66999sC|EE1000', [
        'FAN_DASANYUAN',
        'FAN_HUNYISE',
        'FAN_PENGPENGHU',
        'FAN_SHUANGANKE',
    ...
    test('Case 210', () =>
      runTest('[PPP,2][FFF,3]345p666sCC|EE1000', ['FAN_XIAOSANYUAN', 'FAN_QUEYIMEN', 'FAN_DANDIAOJIANG', 'FAN_ZIMO']))
    test('Case 211', () =>
      runTest('[PPP,2][FFF,3]3335p999s4p|EE1000', ['FAN_SHUANGJIANKE', 'FAN_YAOJIUKE', 'FAN_QUEYIMEN', 'FAN_ZIMO']))
    test('Case 212', () =>
      runTest('[EEE,2][SSS,1][FFF,3]WWNNW|WW1000', [
        'FAN_XIAOSIXI',
        'FAN_ZIYISE',
        'FAN_QUANFENGKE',
        'FAN_MENFENGKE',
    ...
    test('Case 214', () =>
      runTest('[111m,2]111999p11991s|EE1000', ['FAN_QINGYAOJIU', 'FAN_SANANKE', 'FAN_SANTONGKE', 'FAN_ZIMO']))
    test('Case 215', () =>
      runTest('[1111m,2][111p,3]999p11999s|EE1000', ['FAN_QINGYAOJIU', 'FAN_SHUANGANKE', 'FAN_MINGGANG', 'FAN_ZIMO']))
    test('Case 216', () =>
      runTest('1199m119999p1991s|EE1000', ['FAN_QINGYAOJIU', 'FAN_QIDUI', 'FAN_SIGUIYI', 'FAN_ZIMO']))
    test('Case 217', () =>
      runTest('[NNN,3][999s,1][CCC,2]999m11p|ES1000', [
        'FAN_HUNYAOJIU',
        'FAN_WUMENQI',
        'FAN_SHUANGTONGKE',
        'FAN_JIANKE',
    ...
    test('Case 218', () =>
      runTest('99m11pSWWNNPPFFS|EE1000', ['FAN_HUNYAOJIU', 'FAN_QIDUI', 'FAN_QUEYIMEN', 'FAN_ZIMO']))
    test('Case 219', () =>
      runTest('[123p,1][CCC,1]999m79998p|EE1000', [
        'FAN_QUANDAIYAO',
        'FAN_JIANKE',
        'FAN_QUEYIMEN',
        'FAN_LAOSHAOFU',
    ...
    test('Case 222', () =>
      runTest('[EEE,2][SSS,1][CCCC]88m456s|ES1000', [
        'FAN_QUANFENGKE',
        'FAN_MENFENGKE',
        'FAN_JIANKE',
        'FAN_ANGANG',
    ...
    test('Case 223', () =>
      runTest('[WWW,2][NNNN,3][111p,2]99s55m9s|ES1000', [
        'FAN_PENGPENGHU',
        'FAN_YAOJIUKE',
        'FAN_YAOJIUKE',
        'FAN_YAOJIUKE',
    ...
    test('Case 224', () =>
      runTest('[123s,1][333s,2]45678996s|EE1000', ['FAN_QINGYISE', 'FAN_SIGUIYI', 'FAN_LIANLIU', 'FAN_ZIMO']))
    test('Case 225', () => runTest('11224455668899p|EE1000', ['FAN_QINGYISE', 'FAN_QIDUI', 'FAN_ZIMO']))
    test('Case 226', () =>
      runTest('[CCC,2][789m,1]12345mNN6m|EE1000', ['FAN_HUNYISE', 'FAN_QINGLONG', 'FAN_JIANKE', 'FAN_ZIMO']))
    test('Case 227', () => runTest('1122559mNNCCCC9m|EE1000', ['FAN_HUNYISE', 'FAN_QIDUI', 'FAN_SIGUIYI', 'FAN_ZIMO']))
    test('Case 228', () =>
      runTest('12345789p55678m6p|EE1000', ['FAN_QINGLONG', 'FAN_BUQIUREN', 'FAN_PINGHU', 'FAN_QUEYIMEN']))
    ...
    test('Case 233', () =>
      runTest('[789m,1][999s,2]7899p789s9p|EE1000', [
        'FAN_QUANDA',
    ...
    test('Case 234', () =>
      runTest('[444m,2][666m,3]444p44664s', ['FAN_QUANZHONG', 'FAN_QUANSHUANGKE', 'FAN_SANTONGKE']))
    test('Case 235', () =>
      runTest('11223333p33s1122m|EE1000', ['FAN_QUANXIAO', 'FAN_QIDUI', 'FAN_SIGUIYI', 'FAN_ZIMO']))
    test('Case 236', () =>
      runTest('[666m,2][777m,2][999m,2]78886m|EE0100', [
        'FAN_QINGYISE',
        'FAN_DAYUWU',
        'FAN_HUJUEZHANG',
        'FAN_SIGUIYI',
    ...
    test('Case 237', () =>
      runTest('[123p,3]23334p222444s|EE1000', [
        'FAN_XIAOYUWU',
        'FAN_TUIBUDAO',
        'FAN_SHUANGANKE',
        'FAN_SIGUIYI',
    ...
    test('Case 238', () =>
      runTest('[345m,1]567m45556p345s', ['FAN_QUANDAIWU', 'FAN_SANSESANBUGAO', 'FAN_PINGHU', 'FAN_XIXIANGFENG']))
    test('Case 239', () => runTest('[444m,2][666m,3]22244s88p4s', ['FAN_QUANSHUANGKE', 'FAN_SHUANGTONGKE']))
    test('Case 240', () =>
      runTest('[111s,3][222s,3][444s,2]333s22p', [
        'FAN_YISESIJIEGAO',
        'FAN_XIAOYUWU',
        'FAN_QUEYIMEN',
        'FAN_YAOJIUKE',
    ...
    test('Case 242', () =>
      runTest('[444s,2]333m55pWWCCC5p|EE1000', [
        'FAN_SANANKE',
        'FAN_SANSESANJIEGAO',
        'FAN_WUMENQI',
        'FAN_PENGPENGHU',
    ...
    test('Case 243', () =>
      runTest('[444s,2]333666m55pWW5p', ['FAN_SANSESANJIEGAO', 'FAN_PENGPENGHU', 'FAN_SHUANGANKE']))
    test('Case 244', () =>
      runTest('[1111m][1111p,2]11134445s|EE1000', [
        'FAN_SANTONGKE',
        'FAN_MINGANGANG',
        'FAN_SHUANGANKE',
        'FAN_YAOJIUKE',
    ...
    test('Case 245', () =>
      runTest('[234m,1][555m,1]567m55566p', [
        'FAN_SHUANGTONGKE',
        'FAN_SIGUIYI',
        'FAN_DUANYAO',
        'FAN_QUEYIMEN',
    ...
    test('Case 246', () =>
      runTest('[222m,1][555m,2]8m222555p8m', [
        'FAN_PENGPENGHU',
        'FAN_DUANYAO',
        'FAN_SHUANGTONGKE',
        'FAN_SHUANGTONGKE',
    ...
    test('Case 247', () =>
      runTest('[456s,1][456s,1][456s,3]45s55m6s|EE1100', [
        'FAN_YISESITONGSHUN',
        'FAN_QUANZHONG',
        'FAN_QUANDAIWU',
        'FAN_HUJUEZHANG',
    ...
    test('Case 251', () =>
      runTest('[123p,1][234p,1]344556p99s|EE1000', [
        'FAN_YISESIBUGAO',
        'FAN_PINGHU',
        'FAN_QUEYIMEN',
        'FAN_DANDIAOJIANG',
    ...
    test('Case 252', () =>
      runTest('[123m,1][345m,1]567m34sCC5s|EE1000', [
        'FAN_YISESANBUGAO',
        'FAN_XIXIANGFENG',
        'FAN_QUEYIMEN',
        'FAN_ZIMO',
    ...
    test('Case 253', () =>
      runTest('[234p,1]12334567pEE5p|EE1000', ['FAN_YISESANBUGAO', 'FAN_HUNYISE', 'FAN_LIANLIU', 'FAN_ZIMO']))
    test('Case 254', () =>
      runTest('12345566789s22p4s|EE1000', [
        'FAN_QINGLONG',
        'FAN_BUQIUREN',
        'FAN_PINGHU',
        'FAN_YIBANGAO',
    ...
    test('Case 255', () =>
      runTest(
        '123456m456p11789s',
        ['FAN_HUALONG', 'FAN_MENQIANQING', 'FAN_PINGHU', 'FAN_XIXIANGFENG'],
        ['FAN_HUALONG', 'FAN_MENQIANQING', 'FAN_PINGHU', 'FAN_LIANLIU']
      ))
    test('Case 256', () =>
      runTest('[234m,1]11234p233442s', ['FAN_XIAOYUWU', 'FAN_SANSESANTONGSHUN', 'FAN_PINGHU', 'FAN_YIBANGAO']))
    test('Case 257', () =>
      runTest('[345m,1]55567m456p678s|EE1000', [
        'FAN_SANSESANBUGAO',
        'FAN_PINGHU',
        'FAN_DUANYAO',
        'FAN_SIGUIYI',
    ...
    test('Case 259', () =>
      runTest(
        '[123m,1][123p,1]123m12p44s3p',
        ['FAN_XIAOYUWU', 'FAN_PINGHU', 'FAN_YIBANGAO', 'FAN_YIBANGAO', 'FAN_XIXIANGFENG', 'FAN_BIANZHANG'],
        ['FAN_XIAOYUWU', 'FAN_PINGHU', 'FAN_YIBANGAO', 'FAN_XIXIANGFENG', 'FAN_XIXIANGFENG', 'FAN_BIANZHANG']
      ))
    test('Case 260', () =>
      runTest('234567p34567888s', [
        'FAN_MENQIANQING',
        'FAN_PINGHU',
        'FAN_DUANYAO',
        'FAN_LIANLIU',
    ...
    test('Case 267', () =>
      runTest('[CCCC][FFFF]333p67pPP5p|EE1000', [
        'FAN_XIAOSANYUAN',
        'FAN_SANANKE',
        'FAN_HUNYISE',
        'FAN_SHUANGANGANG',
    ...
    test('Case 268', () =>
      runTest('[234m,1][345p,1][234s,1][CCCC,2]11m', [
        'FAN_QUANQIUREN',
        'FAN_JIANKE',
        'FAN_MINGGANG',
        'FAN_XIXIANGFENG',
    ...
    test('Case 269', () =>
      runTest('[234s,2][666s,2]33888sFFF|EE1000', ['FAN_LVYISE', 'FAN_SHUANGANKE', 'FAN_JIANKE', 'FAN_ZIMO']))
    test('Case 270', () =>
      runTest('22333344668888s', [
        'FAN_LVYISE',
        'FAN_QINGYISE',
        'FAN_QIDUI',
        'FAN_DUANYAO',
    ...
    test('Case 271', () =>
      runTest('11123456789999m|EE1000', ['FAN_JIULIANBAODENG', 'FAN_QINGLONG', 'FAN_SIGUIYI', 'FAN_ZIMO']))
    test('Case 272', () =>
      runTest('11123456789992p', ['FAN_JIULIANBAODENG', 'FAN_SHUANGANKE', 'FAN_YAOJIUKE', 'FAN_LIANLIU']))
    test('Case 273', () => runTest('22334556677884s', ['FAN_LIANQIDUI', 'FAN_DUANYAO']))
    test('Case 274', () =>
      runTest('[123p,1]12355778998p|EE1000', ['FAN_YISESHUANGLONGHUI', 'FAN_KANZHANG', 'FAN_ZIMO']))
    test('Case 275', () =>
      runTest('[123m,1][789m,1][123p,1]89p55s7p|EE1000', ['FAN_SANSESHUANGLONGHUI', 'FAN_BIANZHANG', 'FAN_ZIMO']))
    test('Case 276', () =>
      runTest('[234p,1]123345p88999s', ['FAN_YISESANBUGAO', 'FAN_TUIBUDAO', 'FAN_YAOJIUKE', 'FAN_WUZI']))
    test('Case 277', () =>
      runTest('223344558pPPPP8p|EE1000', ['FAN_QIDUI', 'FAN_TUIBUDAO', 'FAN_HUNYISE', 'FAN_SIGUIYI', 'FAN_ZIMO']))
    test('Case 278', () =>
      runTest('[111m,1][123m,1]33455553m|EE1000', [
        'FAN_QINGYISE',
        'FAN_SIGUIYI',
        'FAN_SIGUIYI',
        'FAN_SIGUIYI',
    ...
    test('Case 283', () =>
      runTest('[CCCC][FFFF][PPPP][EEEE]NN|EE1011|8', [
        'FAN_DASANYUAN',
        'FAN_SIGANG',
        'FAN_ZIYISE',
        'FAN_SIANKE',
    ...
    test('Case 286', () =>
      runTest('23422333444562s|EE1000', [
        'FAN_QINGYISE',
        'FAN_BUQIUREN',
        'FAN_SIGUIYI',
        'FAN_SIGUIYI',
    ...
    test('Case 288', () =>
      runTest(
        '234567p234567sEE',
        ['FAN_MENQIANQING', 'FAN_XIXIANGFENG', 'FAN_XIXIANGFENG', 'FAN_LIANLIU', 'FAN_QUEYIMEN', 'FAN_DANDIAOJIANG'],
        ['FAN_MENQIANQING', 'FAN_XIXIANGFENG', 'FAN_LIANLIU', 'FAN_LIANLIU', 'FAN_QUEYIMEN', 'FAN_DANDIAOJIANG']
      ))
    test('Case 290', () => runTest('258m23469p14788s3p', ['FAN_ZUHELONG', 'FAN_MENQIANQING', 'FAN_PINGHU']))
    test('Case 291', () =>
      runTest('258m13369p14788s2p', ['FAN_ZUHELONG', 'FAN_MENQIANQING', 'FAN_PINGHU', 'FAN_KANZHANG']))
    test('Case 293', () =>
      runTest('[1111m][111p,3]999p11999s|EE1001', [
        'FAN_QINGYAOJIU',
        'FAN_SANANKE',
        'FAN_GANGSHANGKAIHUA',
        'FAN_ANGANG',
    ...
    test('Case 295', () =>
      runTest('111999p11999s798p|EE0001', [
        'FAN_SANANKE',
        'FAN_QIANGGANGHU',
        'FAN_QUANDAIYAO',
        'FAN_MENQIANQING',
    ...
    test('Case 296', () =>
      runTest('[111p,3]999p11999s798p|EE0001', [
        'FAN_QIANGGANGHU',
        'FAN_QUANDAIYAO',
        'FAN_SIGUIYI',
        'FAN_SHUANGTONGKE',
    ...
    test('Case 297', () =>
      runTest('[234m,1][555m,1]567m55576p|EE0101|3', [
        'FAN_QIANGGANGHU',
        'FAN_SIGUIYI',
        'FAN_DUANYAO',
        'FAN_XIXIANGFENG',
    ...
    test('Case 299', () =>
      runTest('[123m,1][345m,1]567m34sCC5s|EE1110', [
        'FAN_YISESANBUGAO',
        'FAN_MIAOSHOUHUICHUN',
        'FAN_HUJUEZHANG',
        'FAN_XIXIANGFENG',
    ...
    test('Case 301', () =>
      runTest('[123m,1][345m,1]567m34sCC5s|EE0110', [
        'FAN_YISESANBUGAO',
        'FAN_HAIDILAOYUE',
        'FAN_HUJUEZHANG',
        'FAN_XIXIANGFENG',
    ...
    test('Case 347', () =>
      runTest('[NNN,3]77789m11888p7m|EE0000|', ['FAN_SIGUIYI', 'FAN_SHUANGANKE', 'FAN_YAOJIUKE', 'FAN_QUEYIMEN']))
    test('Case 348', () =>
      runTest('[NNN,3]78889m11888p8m|EE0000|', [
        'FAN_SIGUIYI',
        'FAN_SHUANGTONGKE',
        'FAN_SHUANGANKE',
        'FAN_YAOJIUKE',
    ...
    test('Case 349', () =>
      runTest('1234444678m456p1m|NE1000|', ['FAN_BUQIUREN', 'FAN_SIGUIYI', 'FAN_QUEYIMEN', 'FAN_WUZI']))
    test('Case 351', () =>
      runTest('[1111m][222s,1]78999s44p9s', [
        'FAN_SIGUIYI',
        'FAN_SHUANGANKE',
        'FAN_ANGANG',
        'FAN_YAOJIUKE',
